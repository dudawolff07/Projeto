                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div id="loginAlert" class="alert alert-warning" style="display: none;">
                            <h5><i class="fas fa-exclamation-triangle"></i> Login Necessário</h5>
                            <p>Você precisa estar logado para confirmar o agendamento.</p>
                            <div class="mt-2">
                                <a href="index.php#loginSection" class="btn btn-rosa btn-sm mr-2">
                                    <i class="fas fa-sign-in-alt"></i> Fazer Login
                                </a>
                                <a href="index.php#registerSection" class="btn btn-outline-rosa btn-sm">
                        ...
                        <form id="appointmentForm">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="clientName" placeholder="Seu nome completo" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="clientPhone">Telefone/WhatsApp *</label>
                                    <input type="tel" class="form-control" id="clientPhone" placeholder="(51) 99999-9999" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="clientEmail" placeholder="seu@email.com" required>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="clientNotes" name="clientNotes" rows="3" placeholder="Alguma observação importante? Ex: Corte com franja, coloração específica, etc." style="resize: vertical; min-height: 100px;"></textarea>
                            </div>
                            
                            <div class="total-price-container bg-light p-3 rounded mb-4" style="border: 1px solid #e9ecef;">
...
<style>
/* Garantir que o textarea e o total se comportem bem em mobile */
...
/* Estilo para highlight do alerta de login */
.alert-highlight {
